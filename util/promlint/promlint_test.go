...
go_goroutines 24
`, problems: []promlint.Problem{{Metric: "go_goroutines", Text: msg}}}, {name: "empty help", in: `
# HELP go_goroutines
# TYPE go_goroutines gauge
go_goroutines 24
`, problems: []promlint.Problem{{Metric: "go_goroutines", Text: msg}}}, {name: "no help and empty help", in: `
# HELP go_goroutines
# TYPE go_goroutines gauge
go_goroutines 24
# TYPE go_threads gauge
go_threads 10
`, problems: []promlint.Problem{{Metric: "go_goroutines", Text: msg}, {Metric: "go_threads", Text: msg}}}, {name: "OK", in: `
...
x_milliamperes 10
`, problems: []promlint.Problem{{Metric: "x_milliamperes", Text: `use base unit "amperes" instead of "milliamperes"`}}}, {name: "bytes", in: `
# HELP x_gigabytes Test metric.
# TYPE x_gigabytes untyped
x_gigabytes 10
`, problems: []promlint.Problem{{Metric: "x_gigabytes", Text: `use base unit "bytes" instead of "gigabytes"`}}}, {name: "candela", in: `
# HELP x_kilocandela Test metric.
# TYPE x_kilocandela untyped
x_kilocandela 10
`, problems: []promlint.Problem{{Metric: "x_kilocandela", Text: `use base unit "candela" instead of "kilocandela"`}}}, {name: "grams", in: `
# HELP x_kilograms Test metric.
# TYPE x_kilograms untyped
x_kilograms 10
`, problems: []promlint.Problem{{Metric: "x_kilograms", Text: `use base unit "grams" instead of "kilograms"`}}}, {name: "kelvin", in: `
# HELP x_nanokelvin Test metric.
# TYPE x_nanokelvin untyped
x_nanokelvin 10
`, problems: []promlint.Problem{{Metric: "x_nanokelvin", Text: `use base unit "kelvin" instead of "nanokelvin"`}}}, {name: "kelvins", in: `
# HELP x_nanokelvins Test metric.
# TYPE x_nanokelvins untyped
x_nanokelvins 10
`, problems: []promlint.Problem{{Metric: "x_nanokelvins", Text: `use base unit "kelvins" instead of "nanokelvins"`}}}, {name: "meters", in: `
# HELP x_kilometers Test metric.
# TYPE x_kilometers untyped
x_kilometers 10
`, problems: []promlint.Problem{{Metric: "x_kilometers", Text: `use base unit "meters" instead of "kilometers"`}}}, {name: "metres", in: `
# HELP x_kilometres Test metric.
# TYPE x_kilometres untyped
x_kilometres 10
`, problems: []promlint.Problem{{Metric: "x_kilometres", Text: `use base unit "metres" instead of "kilometres"`}}}, {name: "moles", in: `
# HELP x_picomoles Test metric.
# TYPE x_picomoles untyped
x_picomoles 10
`, problems: []promlint.Problem{{Metric: "x_picomoles", Text: `use base unit "moles" instead of "picomoles"`}}}, {name: "seconds", in: `
# HELP x_microseconds Test metric.
# TYPE x_microseconds untyped
x_microseconds 10
`, problems: []promlint.Problem{{Metric: "x_microseconds", Text: `use base unit "seconds" instead of "microseconds"`}}}, {name: "OK", in: `
...
func TestLintCounter(t *testing.T) {
	...
	tests := []struct {
		...
		in		string
		problems	[]promlint.Problem
	}{{name: "counter without _total suffix", in: `
# HELP x_bytes Test metric.
# TYPE x_bytes counter
x_bytes 10
`, problems: []promlint.Problem{{Metric: "x_bytes", Text: `counter metrics should have "_total" suffix`}}}, {name: "gauge with _total suffix", in: `
# HELP x_bytes_total Test metric.
# TYPE x_bytes_total gauge
x_bytes_total 10
`, problems: []promlint.Problem{{Metric: "x_bytes_total", Text: `non-counter metrics should not have "_total" suffix`}}}, {name: "counter with _total suffix", in: `
# HELP x_bytes_total Test metric.
# TYPE x_bytes_total counter
x_bytes_total 10
`}, {name: "gauge without _total suffix", in: `
# HELP x_bytes Test metric.
# TYPE x_bytes gauge
x_bytes 10
`}, {name: "untyped with _total suffix", in: `
# HELP x_bytes_total Test metric.
# TYPE x_bytes_total untyped
x_bytes_total 10
`}, {name: "untyped without _total suffix", in: `
# HELP x_bytes Test metric.
...
func TestLintHistogramSummaryReserved(t *testing.T) {
	...
	tests := []struct {
		...
		in		string
		problems	[]promlint.Problem
	}{{name: "gauge with _bucket suffix", in: `
# HELP x_bytes_bucket Test metric.
# TYPE x_bytes_bucket gauge
x_bytes_bucket 10
`, problems: []promlint.Problem{{Metric: "x_bytes_bucket", Text: `non-histogram metrics should not have "_bucket" suffix`}}}, {name: "gauge with _count suffix", in: `
# HELP x_bytes_count Test metric.
# TYPE x_bytes_count gauge
x_bytes_count 10
`, problems: []promlint.Problem{{Metric: "x_bytes_count", Text: `non-histogram and non-summary metrics should not have "_count" suffix`}}}, {name: "gauge with _sum suffix", in: `
# HELP x_bytes_sum Test metric.
# TYPE x_bytes_sum gauge
x_bytes_sum 10
`, problems: []promlint.Problem{{Metric: "x_bytes_sum", Text: `non-histogram and non-summary metrics should not have "_sum" suffix`}}}, {name: "gauge with le label", in: `
# HELP x_bytes Test metric.
# TYPE x_bytes gauge
x_bytes{le="1"} 10
`, problems: []promlint.Problem{{Metric: "x_bytes", Text: `non-histogram metrics should not have "le" label`}}}, {name: "gauge with quantile label", in: `
# HELP x_bytes Test metric.
# TYPE x_bytes gauge
x_bytes{quantile="1"} 10
`, problems: []promlint.Problem{{Metric: "x_bytes", Text: `non-summary metrics should not have "quantile" label`}}}, {name: "histogram with quantile label", in: `
...
`, problems: []promlint.Problem{{Metric: "tsdb_compaction_duration", Text: `non-summary metrics should not have "quantile" label`}}}, {name: "summary with le label", in: `
...
`, problems: []promlint.Problem{{Metric: "go_gc_duration_seconds", Text: `non-histogram metrics should not have "le" label`}}}, {name: "histogram OK", in: `
# HELP tsdb_compaction_duration Duration of compaction runs.
# TYPE tsdb_compaction_duration histogram
