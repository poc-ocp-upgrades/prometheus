...
func TestEndpointsDiscoveryAdd(t *testing.T) {
	...
	k8sDiscoveryTest{discovery: n, afterStart: func() {
		obj := &v1.Endpoints{ObjectMeta: metav1.ObjectMeta{Name: "testendpoints", Namespace: "default"}, Subsets: []v1.EndpointSubset{{Addresses: []v1.EndpointAddress{{IP: "4.3.2.1", TargetRef: &v1.ObjectReference{Kind: "Pod", Name: "testpod", Namespace: "default"}}}, Ports: []v1.EndpointPort{{Name: "testport", Port: 9000, Protocol: v1.ProtocolTCP}}}}}
		c.CoreV1().Endpoints(obj.Namespace).Create(obj)
		w.Endpoints().Add(obj)
...
func TestEndpointsDiscoveryEmptySubsets(t *testing.T) {
	...
	k8sDiscoveryTest{discovery: n, afterStart: func() {
		...
		c.CoreV1().Endpoints(obj.Namespace).Update(obj)
		w.Endpoints().Modify(obj)
	}, expectedMaxItems: 2, expectedRes: map[string]*targetgroup.Group{"endpoints/default/testendpoints": {Labels: model.LabelSet{"__meta_kubernetes_namespace": "default", "__meta_kubernetes_endpoints_name": "testendpoints"}, Source: "endpoints/default/testendpoints"}}}.Run(t)
}
...
func TestEndpointsDiscoveryWithServiceUpdate(t *testing.T) {
	...
	k8sDiscoveryTest{discovery: n, beforeRun: func() {
		...
		obj := &v1.Service{ObjectMeta: metav1.ObjectMeta{Name: "testendpoints", Namespace: "default", Labels: map[string]string{"app": "svc", "component": "testing"}}}
