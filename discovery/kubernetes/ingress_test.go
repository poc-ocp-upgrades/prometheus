...
func TestIngressDiscoveryAddTLS(t *testing.T) {
	...
	k8sDiscoveryTest{discovery: n, afterStart: func() {
		...
		c.ExtensionsV1beta1().Ingresses("default").Create(obj)
		w.Ingresses().Add(obj)
	}, expectedMaxItems: 1, expectedRes: expectedTargetGroups("default", TLSYes)}.Run(t)
}
