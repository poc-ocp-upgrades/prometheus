...
func TestExternalLabelsQuerierSelect(t *testing.T) {
	...
	q := &externalLabelsQuerier{Querier: mockQuerier{}, externalLabels: model.LabelSet{"region": "europe"}}
...
func TestSeriesSetFilter(t *testing.T) {
	...
	}{{toRemove: model.LabelSet{"foo": "bar"}, in: &prompb.QueryResult{Timeseries: []*prompb.TimeSeries{{Labels: labelsToLabelsProto(labels.FromStrings("foo", "bar", "a", "b")), Samples: []prompb.Sample{}}}}, expected: &prompb.QueryResult{Timeseries: []*prompb.TimeSeries{{Labels: labelsToLabelsProto(labels.FromStrings("a", "b")), Samples: []prompb.Sample{}}}}}}
...
type mockSeriesSet struct{ storage.SeriesSet }
...
func TestPreferLocalStorageFilter(t *testing.T) {
	...
	}{{localStartTime: int64(100), mint: int64(0), maxt: int64(50), querier: mockQuerier{ctx: ctx, mint: 0, maxt: 50}}, {localStartTime: int64(20), mint: int64(0), maxt: int64(50), querier: mockQuerier{ctx: ctx, mint: 0, maxt: 20}}, {localStartTime: int64(20), mint: int64(30), maxt: int64(50), querier: storage.NoopQuerier()}}
	for i, test := range tests {
		f := PreferLocalStorageFilter(storage.QueryableFunc(func(ctx context.Context, mint, maxt int64) (storage.Querier, error) {
			return mockQuerier{ctx: ctx, mint: mint, maxt: maxt}, nil
		}), func() (int64, error) {
			return test.localStartTime, nil
		})
...
func TestRequiredMatchersFilter(t *testing.T) {
	...
	want := &requiredMatchersQuerier{Querier: mockQuerier{ctx: ctx, mint: 0, maxt: 50}, requiredMatchers: []*labels.Matcher{mustNewLabelMatcher(labels.MatchEqual, "special", "label")}}
...
func TestRequiredLabelsQuerierSelect(t *testing.T) {
	...
	}{{requiredMatchers: []*labels.Matcher{}, matchers: []*labels.Matcher{mustNewLabelMatcher(labels.MatchEqual, "special", "label")}, seriesSet: mockSeriesSet{}}, {requiredMatchers: []*labels.Matcher{mustNewLabelMatcher(labels.MatchEqual, "special", "label")}, matchers: []*labels.Matcher{mustNewLabelMatcher(labels.MatchEqual, "special", "label")}, seriesSet: mockSeriesSet{}}, {requiredMatchers: []*labels.Matcher{mustNewLabelMatcher(labels.MatchEqual, "special", "label")}, matchers: []*labels.Matcher{mustNewLabelMatcher(labels.MatchRegexp, "special", "label")}, seriesSet: storage.NoopSeriesSet()}, {requiredMatchers: []*labels.Matcher{mustNewLabelMatcher(labels.MatchEqual, "special", "label")}, matchers: []*labels.Matcher{mustNewLabelMatcher(labels.MatchEqual, "special", "different")}, seriesSet: storage.NoopSeriesSet()}, {requiredMatchers: []*labels.Matcher{mustNewLabelMatcher(labels.MatchEqual, "special", "label")}, matchers: []*labels.Matcher{mustNewLabelMatcher(labels.MatchEqual, "special", "label"), mustNewLabelMatcher(labels.MatchEqual, "foo", "bar")}, seriesSet: mockSeriesSet{}}, {requiredMatchers: []*labels.Matcher{mustNewLabelMatcher(labels.MatchEqual, "special", "label"), mustNewLabelMatcher(labels.MatchEqual, "foo", "bar")}, matchers: []*labels.Matcher{mustNewLabelMatcher(labels.MatchEqual, "special", "label"), mustNewLabelMatcher(labels.MatchEqual, "foo", "baz")}, seriesSet: storage.NoopSeriesSet()}, {requiredMatchers: []*labels.Matcher{mustNewLabelMatcher(labels.MatchEqual, "special", "label"), mustNewLabelMatcher(labels.MatchEqual, "foo", "bar")}, matchers: []*labels.Matcher{mustNewLabelMatcher(labels.MatchEqual, "special", "label"), mustNewLabelMatcher(labels.MatchEqual, "foo", "bar")}, seriesSet: mockSeriesSet{}}}
	for i, test := range tests {
		q := &requiredMatchersQuerier{Querier: mockQuerier{}, requiredMatchers: test.requiredMatchers}
