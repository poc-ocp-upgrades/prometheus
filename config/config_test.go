...
func TestBadConfigs(t *testing.T) {
	...
	for _, ee := range expectedErrors {
		...
		testutil.Assert(t, strings.Contains(err.Error(), ee.errMsg), "Expected error for %s to contain %q but got: %s", ee.filename, ee.errMsg, err)
	}
}
