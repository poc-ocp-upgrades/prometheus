...
`)
	...
	cases := []struct {
		...
		ShouldError	bool
	}{{Query: "1", Result: Scalar{V: 1, T: 1000}, Start: time.Unix(1, 0)}, {Query: "metric", Result: Vector{Sample{Point: Point{V: 1, T: 1000}, Metric: labels.FromStrings("__name__", "metric")}}, Start: time.Unix(1, 0)}, {Query: "metric[20s]", Result: Matrix{Series{Points: []Point{{V: 1, T: 0}, {V: 2, T: 10000}}, Metric: labels.FromStrings("__name__", "metric")}}, Start: time.Unix(10, 0)}, {Query: "1", Result: Matrix{Series{Points: []Point{{V: 1, T: 0}, {V: 1, T: 1000}, {V: 1, T: 2000}}, Metric: labels.FromStrings()}}, Start: time.Unix(0, 0), End: time.Unix(2, 0), Interval: time.Second}, {Query: "metric", Result: Matrix{Series{Points: []Point{{V: 1, T: 0}, {V: 1, T: 1000}, {V: 1, T: 2000}}, Metric: labels.FromStrings("__name__", "metric")}}, Start: time.Unix(0, 0), End: time.Unix(2, 0), Interval: time.Second}, {Query: "metric", Result: Matrix{Series{Points: []Point{{V: 1, T: 0}, {V: 1, T: 5000}, {V: 2, T: 10000}}, Metric: labels.FromStrings("__name__", "metric")}}, Start: time.Unix(0, 0), End: time.Unix(10, 0), Interval: 5 * time.Second}, {Query: `count_values("wrong label!", metric)`, ShouldError: true}}
	for _, c := range cases {
		var err error
		var qry Query
		if c.Interval == 0 {
...
`)
	...
	cases := []struct {
		...
		End		time.Time
		Interval	time.Duration
	}{{Query: "1", MaxSamples: 1, Result: Result{nil, Scalar{V: 1, T: 1000}, nil}, Start: time.Unix(1, 0)}, {Query: "1", MaxSamples: 0, Result: Result{ErrTooManySamples(env), nil, nil}, Start: time.Unix(1, 0)}, {Query: "metric", MaxSamples: 0, Result: Result{ErrTooManySamples(env), nil, nil}, Start: time.Unix(1, 0)}, {Query: "metric", MaxSamples: 1, Result: Result{nil, Vector{Sample{Point: Point{V: 1, T: 1000}, Metric: labels.FromStrings("__name__", "metric")}}, nil}, Start: time.Unix(1, 0)}, {Query: "metric[20s]", MaxSamples: 2, Result: Result{nil, Matrix{Series{Points: []Point{{V: 1, T: 0}, {V: 2, T: 10000}}, Metric: labels.FromStrings("__name__", "metric")}}, nil}, Start: time.Unix(10, 0)}, {Query: "rate(metric[20s])", MaxSamples: 3, Result: Result{nil, Vector{Sample{Point: Point{V: 0.1, T: 10000}, Metric: labels.Labels{}}}, nil}, Start: time.Unix(10, 0)}, {Query: "metric[20s:5s]", MaxSamples: 3, Result: Result{nil, Matrix{Series{Points: []Point{{V: 1, T: 0}, {V: 1, T: 5000}, {V: 2, T: 10000}}, Metric: labels.FromStrings("__name__", "metric")}}, nil}, Start: time.Unix(10, 0)}, {Query: "metric[20s]", MaxSamples: 0, Result: Result{ErrTooManySamples(env), nil, nil}, Start: time.Unix(10, 0)}, {Query: "1", MaxSamples: 3, Result: Result{nil, Matrix{Series{Points: []Point{{V: 1, T: 0}, {V: 1, T: 1000}, {V: 1, T: 2000}}, Metric: labels.FromStrings()}}, nil}, Start: time.Unix(0, 0), End: time.Unix(2, 0), Interval: time.Second}, {Query: "1", MaxSamples: 0, Result: Result{ErrTooManySamples(env), nil, nil}, Start: time.Unix(0, 0), End: time.Unix(2, 0), Interval: time.Second}, {Query: "metric", MaxSamples: 3, Result: Result{nil, Matrix{Series{Points: []Point{{V: 1, T: 0}, {V: 1, T: 1000}, {V: 1, T: 2000}}, Metric: labels.FromStrings("__name__", "metric")}}, nil}, Start: time.Unix(0, 0), End: time.Unix(2, 0), Interval: time.Second}, {Query: "metric", MaxSamples: 2, Result: Result{ErrTooManySamples(env), nil, nil}, Start: time.Unix(0, 0), End: time.Unix(2, 0), Interval: time.Second}, {Query: "metric", MaxSamples: 3, Result: Result{nil, Matrix{Series{Points: []Point{{V: 1, T: 0}, {V: 1, T: 5000}, {V: 2, T: 10000}}, Metric: labels.FromStrings("__name__", "metric")}}, nil}, Start: time.Unix(0, 0), End: time.Unix(10, 0), Interval: 5 * time.Second}, {Query: "metric", MaxSamples: 2, Result: Result{ErrTooManySamples(env), nil, nil}, Start: time.Unix(0, 0), End: time.Unix(10, 0), Interval: 5 * time.Second}}
	...
	tests := []struct {
		...
		cases		[]struct {
			...
			Start	time.Time
							...
							metric 1 2`, cases: []struct {
		Query	string
		Result	Result
		Start	time.Time
	}{{Query: "metric[20s:10s]", Result: Result{nil, Matrix{Series{Points: []Point{{V: 1, T: 0}, {V: 2, T: 10000}}, Metric: labels.FromStrings("__name__", "metric")}}, nil}, Start: time.Unix(10, 0)}, {Query: "metric[20s:5s]", Result: Result{nil, Matrix{Series{Points: []Point{{V: 1, T: 0}, {V: 1, T: 5000}, {V: 2, T: 10000}}, Metric: labels.FromStrings("__name__", "metric")}}, nil}, Start: time.Unix(10, 0)}, {Query: "metric[20s:5s] offset 2s", Result: Result{nil, Matrix{Series{Points: []Point{{V: 1, T: 0}, {V: 1, T: 5000}, {V: 2, T: 10000}}, Metric: labels.FromStrings("__name__", "metric")}}, nil}, Start: time.Unix(12, 0)}, {Query: "metric[20s:5s] offset 6s", Result: Result{nil, Matrix{Series{Points: []Point{{V: 1, T: 0}, {V: 1, T: 5000}, {V: 2, T: 10000}}, Metric: labels.FromStrings("__name__", "metric")}}, nil}, Start: time.Unix(20, 0)}, {Query: "metric[20s:5s] offset 4s", Result: Result{nil, Matrix{Series{Points: []Point{{V: 2, T: 15000}, {V: 2, T: 20000}, {V: 2, T: 25000}, {V: 2, T: 30000}}, Metric: labels.FromStrings("__name__", "metric")}}, nil}, Start: time.Unix(35, 0)}, {Query: "metric[20s:5s] offset 5s", Result: Result{nil, Matrix{Series{Points: []Point{{V: 2, T: 10000}, {V: 2, T: 15000}, {V: 2, T: 20000}, {V: 2, T: 25000}, {V: 2, T: 30000}}, Metric: labels.FromStrings("__name__", "metric")}}, nil}, Start: time.Unix(35, 0)}, {Query: "metric[20s:5s] offset 6s", Result: Result{nil, Matrix{Series{Points: []Point{{V: 2, T: 10000}, {V: 2, T: 15000}, {V: 2, T: 20000}, {V: 2, T: 25000}}, Metric: labels.FromStrings("__name__", "metric")}}, nil}, Start: time.Unix(35, 0)}, {Query: "metric[20s:5s] offset 7s", Result: Result{nil, Matrix{Series{Points: []Point{{V: 2, T: 10000}, {V: 2, T: 15000}, {V: 2, T: 20000}, {V: 2, T: 25000}}, Metric: labels.FromStrings("__name__", "metric")}}, nil}, Start: time.Unix(35, 0)}}}, {loadString: `load 10s
							http_requests{job="api-server", instance="0", group="production"}	0+10x1000 100+30x1000
							http_requests{job="api-server", instance="1", group="production"}	0+20x1000 200+30x1000
							http_requests{job="api-server", instance="0", group="canary"}		0+30x1000 300+80x1000
							http_requests{job="api-server", instance="1", group="canary"}		0+40x2000`, cases: []struct {
		Query	string
		Result	Result
		Start	time.Time
	}{{Query: `http_requests{group=~"pro.*",instance="0"}[30s:10s]`, Result: Result{nil, Matrix{Series{Points: []Point{{V: 9990, T: 9990000}, {V: 10000, T: 10000000}, {V: 100, T: 10010000}, {V: 130, T: 10020000}}, Metric: labels.FromStrings("__name__", "http_requests", "job", "api-server", "instance", "0", "group", "production")}}, nil}, Start: time.Unix(10020, 0)}, {Query: `http_requests{group=~"pro.*",instance="0"}[5m:]`, Result: Result{nil, Matrix{Series{Points: []Point{{V: 9840, T: 9840000}, {V: 9900, T: 9900000}, {V: 9960, T: 9960000}, {V: 130, T: 10020000}, {V: 310, T: 10080000}}, Metric: labels.FromStrings("__name__", "http_requests", "job", "api-server", "instance", "0", "group", "production")}}, nil}, Start: time.Unix(10100, 0)}, {Query: `http_requests{group=~"pro.*",instance="0"}[5m:] offset 20m`, Result: Result{nil, Matrix{Series{Points: []Point{{V: 8640, T: 8640000}, {V: 8700, T: 8700000}, {V: 8760, T: 8760000}, {V: 8820, T: 8820000}, {V: 8880, T: 8880000}}, Metric: labels.FromStrings("__name__", "http_requests", "job", "api-server", "instance", "0", "group", "production")}}, nil}, Start: time.Unix(10100, 0)}, {Query: `rate(http_requests[1m])[15s:5s]`, Result: Result{nil, Matrix{Series{Points: []Point{{V: 3, T: 7985000}, {V: 3, T: 7990000}, {V: 3, T: 7995000}, {V: 3, T: 8000000}}, Metric: labels.FromStrings("job", "api-server", "instance", "0", "group", "canary")}, Series{Points: []Point{{V: 4, T: 7985000}, {V: 4, T: 7990000}, {V: 4, T: 7995000}, {V: 4, T: 8000000}}, Metric: labels.FromStrings("job", "api-server", "instance", "1", "group", "canary")}, Series{Points: []Point{{V: 1, T: 7985000}, {V: 1, T: 7990000}, {V: 1, T: 7995000}, {V: 1, T: 8000000}}, Metric: labels.FromStrings("job", "api-server", "instance", "0", "group", "production")}, Series{Points: []Point{{V: 2, T: 7985000}, {V: 2, T: 7990000}, {V: 2, T: 7995000}, {V: 2, T: 8000000}}, Metric: labels.FromStrings("job", "api-server", "instance", "1", "group", "production")}}, nil}, Start: time.Unix(8000, 0)}, {Query: `sum(http_requests{group=~"pro.*"})[30s:10s]`, Result: Result{nil, Matrix{Series{Points: []Point{{V: 270, T: 90000}, {V: 300, T: 100000}, {V: 330, T: 110000}, {V: 360, T: 120000}}, Metric: labels.Labels{}}}, nil}, Start: time.Unix(120, 0)}, {Query: `sum(http_requests)[40s:10s]`, Result: Result{nil, Matrix{Series{Points: []Point{{V: 800, T: 80000}, {V: 900, T: 90000}, {V: 1000, T: 100000}, {V: 1100, T: 110000}, {V: 1200, T: 120000}}, Metric: labels.Labels{}}}, nil}, Start: time.Unix(120, 0)}, {Query: `(sum(http_requests{group=~"p.*"})+sum(http_requests{group=~"c.*"}))[20s:5s]`, Result: Result{nil, Matrix{Series{Points: []Point{{V: 1000, T: 100000}, {V: 1000, T: 105000}, {V: 1100, T: 110000}, {V: 1100, T: 115000}, {V: 1200, T: 120000}}, Metric: labels.Labels{}}}, nil}, Start: time.Unix(120, 0)}}}}
